...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------- |
| 01  | Cómo **cliente quiero** ingresar a la plataforma de InstaYA, **registrarme**, con mis datos de contacto y personales, **para acceder** a los servicios de la plataforma y posteriormente agendar mi entrega                                                                                  | Diseño de la vista de login y de regitro de usuario nuevo<ul><li>Vista Login<li>Vista Registro Nuevo Usuario</ul>                                                                                                                                                                                                                                                                                                                                                                     | 5 **Pequeño** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> back-End<ul><li>DaritzaTV<br>JavierTV</ul> |
| 02  | Cómo **cliente quiero** ver las horas de entrega disponibles **para seleccionar** a mi conveniencia la que se ajuste a mis necesidades.                                                                                                                                                      | Crear el diseño del boton o cuadro donde se observen las horas disponibles para recogida y envíos.<ul><li>BD Pedidos</li><ul><li>Fechas</li></ul><li>Vista Agendar Entrega</li><ul><li>Fechas Disponibles</li></ul></ul>                                                                                                                                                                                                                                                              | 3 **Pequeño** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> back-End<ul><li>DaritzaTV<br>JavierTV</ul> |
| 03  | Cómo **cliente quiero** crear mi orden según el día, hora, las dimensiones del paquete, dirección de recogida, mis datos personales y los datos de entrega como la direccion, ciudad, identificación y nombre de quien recibe **para** que el envío sea realizado y entregado adecuadamente. | Diseño de la vista de creación de orden de envío donde se digiten todos los datos del paquete, remitente y destinatario.<ul><li>BD Envíos<ul><li>Mercancía</li><ul><li>Dimensiones</li><li>Peso</li></ul></li><li>Remitente</li><ul><li>Fecha Recogida</li><li>Identificación</li><li>Nombre Completo</li><li>Dirección recogida/ciudad</li></ul><li>Destinatario</li><ul><li>Fecha Entrega</li><li>Identificación</li><li>Nombre Completo</li><li>Dirección entrega/ciudad</li></ul> | 5 **Pequeño** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> back-End<ul><li>DaritzaTV<br>JavierTV</ul> |
| 04  | Cómo **cliente quiero** hacer seguimiento a mis pedidos y ver el listado de los mismos con el estado actual del envío **para asegurarme** que los pedidos se estén entregando según los requerimientos (ejemplo: máximo en **24 horas**)                                                     | Diseño de la vista del resumen de los pedidos donde se pueda observar todo el listado de pedidos según su estado<ul><li>BD Actualización & Registro Listado Ordenes</li><ul><li>Código de Seguimiento</li><li>Estado Envio</li><ul><li>Guardado</li><li>Cancelado</li><li>Cumplido                                                                                                                                                                                                    | 3 **Pequeño** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> back-End<ul><li>DaritzaTV<br>JavierTV</ul> |
| 05  | Cómo **cliente quiero** actualizar los datos de mis órdenes realizadas con anterioridad **para poder** gestionarlas en caso de que algún dato haya cambiado o se haya digitado erróneamente.                                                                                                 | Diseño de la vista de actualización de pedido donde se pueda ver y/o modificar algún dato del pedido o cancelar el mismo.<ul><li>Gestión de envíos/paquetes<ul><li>Actualización del paquete</li><li>Actualización datos Remitente</li><li>Actualización datos Destinatario</li></ul></ul>                                                                                                                                                                                            | 5 **Pequeño** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> back-End<ul><li>DaritzaTV<br>JavierTV</ul> |
...
| Id  | User Story                                                                                                                                                                                                                                                                                   | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Estimación     | Responsable                                                                                                                      |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| 01  | Cómo **cliente quiero** ingresar a la plataforma de InstaYA, **registrarme**, con mis datos de contacto y personales, **para acceder** a los servicios de la plataforma y posteriormente agendar mi entrega                                                                                  | Creación de la ventana del login, con estilos de bootstrap, y del registro de nuevo usuario con los botones y links de acceso a cada uno<ul><li>Ventana Login<li>Ventana Registro Nuevo Usuario</ul>                                                                                                                                                                                                                                                                                                                                                          | 5 **Promedio** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul>                                                        |
| 02  | Cómo **cliente quiero** ver las horas de entrega disponibles **para seleccionar** a mi conveniencia la que se ajuste a mis necesidades.                                                                                                                                                      | Creación de la vista de horarios disponibles por medio de boostrap, los botones y cuadros necesarios donde se observen las horas disponibles para recogida y envíos.<ul><li>BD Pedidos</li><ul><li>Fechas</li></ul><li>Vista Agendar Entrega</li><ul><li>Fechas Disponibles</li></ul></ul>                                                                                                                                                                                                                                                                    | 3 **Pequeño**  | Full-Stack<ul><li>AngelDM<li>DaritzaTV<li>JesúsVA</ul> Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul> |
| 03  | Cómo **cliente quiero** crear mi orden según el día, hora, las dimensiones del paquete, dirección de recogida, mis datos personales y los datos de entrega como la direccion, ciudad, identificación y nombre de quien recibe **para** que el envío sea realizado y entregado adecuadamente. | Creación de la ventana de ingresar o crear orden de envío con los cuadros de texto para digitar la información correspondiente y los botones que guarden la información digitada en el frontend.<ul><li>BD Envíos<ul><li>Mercancía</li><ul><li>Dimensiones</li><li>Peso</li></ul></li><li>Remitente</li><ul><li>Fecha Recogida</li><li>Identificación</li><li>Nombre Completo</li><li>Dirección recogida/ciudad</li></ul><li>Destinatario</li><ul><li>Fecha Entrega</li><li>Identificación</li><li>Nombre Completo</li><li>Dirección entrega/ciudad</li></ul> | 5 **Promedio** | Full-Stack<ul><li>JesúsVA</ul> front-End<ul><li>AngelDM<br>DanielaOR</ul>                                                        |
...
| 05  | Cómo **cliente quiero** actualizar los datos de mis órdenes realizadas con anterioridad **para poder** gestionarlas en caso de que algún dato haya cambiado o se haya digitado erróneamente.                                                                                                 | Creación de la ventana de actualización de pedido donde se pueda ver y/o modificar algún dato del pedido o cancelar el mismo. Esto sólo se podrá realizar en pedidos que aún no se hayan cumplido ni cancelado. Una vez Se guarden los datos, el frontend los almacenará para enviarlos al backend.<ul><li>Gestión de envíos/paquetes<ul><li>Actualización del paquete</li><li>Actualización datos Remitente</li><li>Actualización datos Destinatario</li></ul></ul>                                                                                          | 5 **Promedio** | front-End<ul><li>AngelDM<br>DanielaOR</ul>                                                                                       |
